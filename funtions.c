...
/************************* WRITE HANDLE *************************/
/**
 * handle_character_print - Handles the printing of a character
 ...
 * Author: Erick Buka
 */
int handle_character_print(char c, char buffer[],
...
/************************* WRITE NUMBER *************************/
/**
 * write_integer - Handles the printing of an integer
	...
	int flags, int width, int precision, int size)
{
	...
	return (write_number_helper(ind, buffer, flags, width, precision,
		length, padding, extra_char));
}

/**
 * write_number_helper - Write a number using a buffer
 ...
 */
int write_number_helper(int ind, char buffer[],
